        ...
        <div class="content-wrap">
            <div class="page-container">
                <ul>
                    ...
                    <li><a <?php if ($link == '/daginstellingen/index.php' || $link == '/daginstellingen/rules.php') { ?> id="menuLinkActive" <?php }?> class="menuLink" href="<?= $dotsString ?>/daginstellingen">Daginstellingen</a></li>
                    <?php /*
                    <li><a class="menuLink" href="./">Tafelindeling</a></li> */ ?>

                    <li><a <?php if ($link == '/medewerkers-instellingen/index.php' || $link == '/medewerkers-instellingen/details.php' || $link == '/inloggen/register.php') { ?> id="menuLinkActive" <?php }?> class="menuLink" href="<?= $dotsString ?>/medewerkers-instellingen">Medewerkers</a></li>
            </div>
            <ul>
